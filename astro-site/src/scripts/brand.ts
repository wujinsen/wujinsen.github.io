import { brandMeta } from '../data/brand';

export const brandTitles = brandMeta.title;

export function initBrandClient() {
  ...
  function setLang(lang: string) {
    ...
    document.title = brandTitles[lang as keyof typeof brandTitles];
